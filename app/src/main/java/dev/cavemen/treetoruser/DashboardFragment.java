...
//        Button topstudent=view.findViewById(R.id.starstudentbtn);


//        topstudent.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View v) {
//                Fragment topStudentFragment=new TopStudentFragment();
//
//                getFragmentManager().beginTransaction().replace(R.id.fragment_container,topStudentFragment).addToBackStack("DashboardFragment").commit();
//
//            }
//        });
//
...
//        });
        ...
        allstudent.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Fragment allBatchFragment=new DiaryFragment();
