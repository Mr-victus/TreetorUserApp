...
public class InsituteSelectedCourseFragmentAdapter extends RecyclerView.Adapter<InsituteSelectedCourseFragmentAdapter.viewholder> {

    ArrayList<String> coursename,coursetiming,coursetaughtby,courseweekdays,coursefees;
    ...
    public InsituteSelectedCourseFragmentAdapter(ArrayList<String> coursename, ArrayList<String> coursetiming, ArrayList<String> coursetaughtby, ArrayList<String> courseweekdays, ArrayList<String> coursefees, Context context, FragmentManager f_manager) {
        this.coursename = coursename;
        this.coursetiming = coursetiming;
        this.coursetaughtby = coursetaughtby;
    ...
    public void onBindViewHolder(@NonNull viewholder holder, final int position) {
        ...
        holder.name.setText("Name: "+coursename.get(position));
        holder.rating.setText("Rating: "+coursetiming.get(position));
        holder.subject.setText("subject: "+coursetaughtby.get(position));
        holder.area.setText("Experience: "+coursefees.get(position));
        //holder.availablity.setText("Name: "+institutename.get(position));
        holder.xp.setText(courseweekdays.get(position)+"Xp");
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(context,""+coursename.get(position),Toast.LENGTH_SHORT).show();
